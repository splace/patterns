...
func (s MoveTo) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
	b.dccx, b.dccy = 0, 0
...
func (s MoveToRelative) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
	b.dccx, b.dccy = 0, 0
...
func (s LineTo) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
	b.dccx, b.dccy = 0, 0
...
func (s LineToRelative) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
	b.dccx, b.dccy = 0, 0
...
func (s VerticalLineTo) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
	b.dccx, b.dccy = 0, 0
...
func (s VerticalLineToRelative) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
	b.dccx, b.dccy = 0, 0
...
func (s HorizontalLineTo) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
	b.dccx, b.dccy = 0, 0
...
func (s HorizontalLineToRelative) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
	b.dccx, b.dccy = 0, 0
...
func (s Close) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
	b.dccx, b.dccy = 0, 0
	return b.LineClose()
}
...
func (s CloseRelative) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
	b.dccx, b.dccy = 0, 0
	return b.LineClose()
}
...
func (s QuadraticBezierTo) Draw(b *Brush) Limited {
...
func (s QuadraticBezierToRelative) Draw(b *Brush) Limited {
	b.dccx, b.dccy = 0, 0
	b.dqcx, b.dqcy = s[2]-s[0], s[3]-s[1]
...
func (s CubicBezierTo) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
...
func (s CubicBezierToRelative) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
	b.dccx, b.dccy = s[4]-s[2], s[5]-s[3]
...
func (s SmoothQuadraticBezierTo) Draw(b *Brush) Limited {
	b.dccx, b.dccy = 0, 0
...
func (s SmoothQuadraticBezierToRelative) Draw(b *Brush) Limited {
	b.dccx, b.dccy = 0, 0
...
func (s SmoothCubicBezierTo) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
...
func (s SmoothCubicBezierToRelative) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
...
func (s ArcTo) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
	b.dccx, b.dccy = 0, 0
...
func (s ArcToRelative) Draw(b *Brush) Limited {
	b.dqcx, b.dqcy = 0, 0
	b.dccx, b.dccy = 0, 0
